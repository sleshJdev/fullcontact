...
VALUES
  (1, 1, '1111111', 1, 'comment1', 'countrycode1', 'operatorcode1'),
  (2, 2, '2222222', 1, 'comment2', 'countrycode2', 'operatorcode2'),
  (3, 3, '3333333', 1, 'comment3', 'countrycode3', 'operatorcode3'),
  (4, 4, '4444444', 2, 'comment4', 'countrycode4', 'operatorcode4'),
  (5, 5, '5555555', 2, 'comment5', 'countrycode5', 'operatorcode5'),
  (6, 6, '6666666', 2, 'comment6', 'countrycode6', 'operatorcode6'),
  (7, 7, '7777777', 1, 'comment7', 'countrycode7', 'operatorcode7'),
  (8, 8, '8888888', 1, 'comment8', 'countrycode8', 'operatorcode8'),
  (9, 9, '9999999', 2, 'comment9', 'countrycode19', 'operatorcode9'),
  (10, 10, '1000000', 1, 'comment10', 'countrycode10', 'operatorcode10'),
  (11, 11, '2111111', 1, 'comment11', 'countrycode11', 'operatorcode11'),
  (12, 12, '2333333', 2, 'comment12', 'countrycode12', 'operatorcode12'),
  (13, 13, '2444444', 1, 'comment13', 'countrycode13', 'operatorcode13'),
  (14, 14, '2555555', 1, 'comment14', 'countrycode14', 'operatorcode14'),
  (15, 15, '2666666', 2, 'comment15', 'countrycode15', 'operatorcode15'),
  (16, 1, '2666677', 2, 'comment15', 'countrycode15', 'operatorcode15'),
  (17, 1, '2666688', 2, 'comment15', 'countrycode15', 'operatorcode15'),
  (18, 1, '2666699', 2, 'comment15', 'countrycode15', 'operatorcode15'),
  (19, 1, '2666600', 2, 'comment15', 'countrycode15', 'operatorcode15'),
  (20, 1, '2666611', 2, 'comment15', 'countrycode15', 'operatorcode15'),
  (21, 1, '2666622', 2, 'comment15', 'countrycode15', 'operatorcode15');
